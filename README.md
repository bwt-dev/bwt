...
```bash
$ wget https://github.com/shesek/bwt/releases/download/v0.1.4bwt-0.1.4-x86_64-linux.tar.gz

# Verify signature
$ gpg --keyserver keyserver.ubuntu.com --recv-keys FCF19B67866562F08A43AAD681F6104CD0F150FC
$ wget -qO - https://github.com/shesek/bwt/releases/download/v0.1.4SHA256SUMS.asc \
